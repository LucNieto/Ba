...
namespace MetroFormDB {
    public partial class ProveedoresSqlServer : MetroFramework.Forms.MetroForm {
        private List<Suppliers> proveedores = new List<Suppliers>();
        private Suppliers proveedor;
        public ProveedoresSqlServer() {
            InitializeComponent();
        }

        private void ProveedoresSqlServer_Load(object sender, EventArgs e) {
            GetProveedores();
        }
