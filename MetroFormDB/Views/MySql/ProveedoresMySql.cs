...
namespace MetroFormDB {
    public partial class ProveedoresMySql : MetroFramework.Forms.MetroForm {
        private List<Suppliers> proveedores = new List<Suppliers>();
        private Suppliers proveedor;
        public ProveedoresMySql() {
            InitializeComponent();
        }

        private void ProveedoresMySql_Load(object sender, EventArgs e) {
            GetProveedores();
        }
